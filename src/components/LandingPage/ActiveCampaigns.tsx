  ...
  const prevSlide = (campaignId: string) => {
    ...
    if (campaign && campaign.images) {
      setActiveSlide((prev) => ({
        ...prev,
        [campaignId]:
          (prev[campaignId] - 1 + campaign.images.length) %
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-600 text-lg">
              Join hands with us to make a meaningful difference. Your support
              can transform lives and communities in need.
            </p>
          </div>
        </div>
                    ...
                    {campaign.images && campaign.images.length > 0 ? (
                          ...
                          {campaign.images.map((image, index) => (
                            <div
                              ...
                              className={`absolute inset-0 transition-opacity duration-500 ${
                                index === activeSlide[campaign._id]
                                  ? "opacity-100"
                                  : "opacity-0"
                              }`}
                            >
                      ...
                      <div className="flex items-center justify-center h-full">
                        <div className="text-emerald-300">
                          ...
                          <p className="text-center mt-2 text-emerald-500 font-medium">
                            No image available
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center mt-3 pt-3 border-t border-gray-100">
                      ...
                      <div className="ml-auto">
                        <Button className="bg-gradient-to-r from-emerald-500 to-emerald-700 hover:from-emerald-600 hover:to-emerald-800 text-white shadow-md hover:shadow-lg transition-all duration-300 rounded-xl">
                          Donate Now
                        </Button>
                      </div>
                    </div>
